...
# This part is image labels setting start
        ...
        # backgorund image
        bg1 = Image.open(r"F:\Ishaan\Python_Test_Projects\Images_GUI\bg4.png")
        ...
        # title section
        title_lb1 = Label(bg_img, text="Developer Pannel", font=(
        ...
        std_img_btn = Image.open(
            r"F:\Ishaan\Python_Test_Projects\Images_GUI\devloper1.jpg")
        ...
        std_b1_1 = Button(bg_img, text="Morani Ishaan ", cursor="hand2", font=(
            "tahoma", 15, "bold"), bg="white", fg="navyblue")
        std_b1_1.place(x=250, y=380, width=180, height=45)

        # Detect Face  button 2
        det_img_btn = Image.open(
            r"F:\Ishaan\Python_Test_Projects\Images_GUI\devloper2.jpg")
        ...
        det_b1_1 = Button(bg_img, text="Satyajit Singh", cursor="hand2", font=(
            "tahoma", 15, "bold"), bg="white", fg="navyblue")
        det_b1_1.place(x=480, y=380, width=180, height=45)

        # Attendance System  button 3
        att_img_btn = Image.open(
            r"F:\Ishaan\Python_Test_Projects\Images_GUI\devloper3.jpg")
        ...
        att_b1_1 = Button(bg_img, text="Sudheer Kumar", cursor="hand2", font=(
            "tahoma", 15, "bold"), bg="white", fg="navyblue")
