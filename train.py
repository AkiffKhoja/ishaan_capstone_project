...
class Train:
    ...
    def __init__(self, root):
        ...
        # backgorund image
        bg1 = Image.open(
            r"F:\Ishaan\Python_Test_Projects\Images_GUI\t_bg1.jpg")
        ...
        # title section
        title_lb1 = Label(bg_img, text="Welcome to Training Pannel", font=(
        ...
        std_img_btn = Image.open(
            r"F:\Ishaan\Python_Test_Projects\Images_GUI\t_btn1.png")
    ...
    def train_classifier(self):
        ...
        messagebox.showinfo(
            "Result", "Training Dataset Complated!", parent=self.root)
